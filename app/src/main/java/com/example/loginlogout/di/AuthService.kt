    ...
    override suspend fun login(email: String, password: String): Response<LoginResponse> {
        ...
        try {
            ...
            if (response.isSuccessful) {
                val errorResponseBody = "This is an error message".toResponseBody("text/plain".toMediaTypeOrNull())
                val errorResponse = Response.error<String>(response.code(), errorResponseBody)
                ...
                val errorMessage = errorBody?.message ?: response.message() ?: "Unknown error"
